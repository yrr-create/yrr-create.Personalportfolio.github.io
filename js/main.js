        ...
        const personalProjects = [
            {
                ...
                title: "BLE Warehouse Asset Tag",
                titleZh: "BLE 仓储资产标签",
                desc: "A low-power BLE warehouse asset tag based on nRF52810 and Ebyte E73-2G4M04S1A. It supports nearby item finding, BLE command control, LED/buzzer alerts, button interaction, and status/environment data reporting for shelves, tools, samples, and reusable containers.",
                descZh: "基于 nRF52810 与亿佰特 E73-2G4M04S1A 的低功耗 BLE 仓储资产标签。支持近距离寻物、BLE 命令控制、LED/蜂鸣器提醒、按键交互，以及状态与环境数据上报，适用于仓库货架、工具、样品和周转箱管理。",
                tags: ["nRF52810", "BLE", "E73", "AHT20", "SGP40", "VOC"],
                tagsZh: ["nRF52810", "BLE", "E73", "AHT20", "SGP40", "VOC"],
                keyWork: [
                    "Implemented a BLE warehouse asset tag workflow covering advertising, connection, idle state, find-alert state, and alert stop behavior.",
                    ...
                    "Added nearby item finding feedback with P0.18 LED indication, PWM buzzer alert, and board button stop control.",
                ...
                keyWorkZh: [
                    "实现 BLE 仓储资产标签工作流程，覆盖广播、连接、空闲、查找提醒和提醒停止行为。",
                    "基于 nRF52810 与 S112 SoftDevice 实现 BLE UART 通信，使用 findon、findoff 和 s? 命令完成设备控制与状态查询。",
                    "通过 P0.18 LED 指示、PWM 蜂鸣器提醒和板载按键停止控制，实现近距离寻物反馈。",
